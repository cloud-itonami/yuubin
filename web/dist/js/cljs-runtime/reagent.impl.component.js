...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22210 = c;
var G__22210__$1 = (((G__22210 == null))?null:G__22210.prototype);
if((G__22210__$1 == null)){
return null;
} else {
return G__22210__$1.reagentRender;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__22222 = c;
var G__22222__$1 = (((G__22222 == null))?null:G__22222.constructor);
if((G__22222__$1 == null)){
return null;
} else {
return G__22222__$1.displayName;
}
})();
...
var G__22223 = c;
var G__22223__$1 = (((G__22223 == null))?null:G__22223.constructor);
if((G__22223__$1 == null)){
return null;
} else {
return G__22223__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__22231 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22232 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22232);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22231);
}});
...
var c = this;
var G__22242_22325 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__22242_22325 == null)){
} else {
reagent.ratom.dispose_BANG_(G__22242_22325);
}
...
var renders_22329 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22330 = cljs.core.first(cljs.core.vals(renders_22329));
...
if((cljs.core.count(renders_22329) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22329))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22330)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22330], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__22247 = o;
reagent.impl.component.goog$module$goog$object.set(G__22247,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__22277 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22278 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22278);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22277);
}});
...
var vec__22279 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22279,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22279,(1),null);
...
var G__22282 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__22282 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22282);
}
});
}),[]);
